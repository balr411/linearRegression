...
The above checks all parts of the implemented functions for correctness by checking against the output of the base/stats package lm, anova, and summary functions. "Not all equal" was not printed once, meaning our functions were correct on each run. These same 16 checks were included during unit testing as can be found in the tests directory. 
