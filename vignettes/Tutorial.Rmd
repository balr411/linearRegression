...
```{r}
fit_mlr_int<-linearRegression::linearRegression(mpg~cyl+disp+hp+wt+cyl+cyl:disp:hp, dat=mtcars)
...
```{r}
fit_mlr_int_lm<-lm(mpg~cyl+disp+hp+wt+cyl+cyl:disp:hp, data=mtcars)
