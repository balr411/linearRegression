...
test_that("test if functions work when no dat given and 3-way interaction included",{
  y<<-rnorm(100)
  x1<<-rnorm(100)
  x2<<-rnorm(100)
  x3<<-rnorm(100)

  fit_linReg<-linearRegression(y~x1+x2+x3+x1:x2+x2:x3+x1:x2:x3)
  fit_lm<-lm(y~x1+x2+x3+x1:x2+x2:x3+x1:x2:x3)
  ...
  expect_equal(fit_linReg$df.residual,fit_lm$df.residual)
  expect_equal(as.numeric(as.matrix(fit_linReg$model)), as.numeric(as.matrix(fit_lm$model)))
  expect_equal(fit_linReg$formula, formula(y~x1+x2+x3+x1:x2+x2:x3+x1:x2:x3))
  ...
  expect_equal(summary_fit_linReg$F.stat, as.numeric(summary_fit_lm$fstatistic[1]))
  expect_equal(summary_fit_linReg$df, as.vector(summary_fit_lm$fstatistic[2:3]))
  expect_equal(summary_fit_linReg$formula, formula(y~x1+x2+x3+x1:x2+x2:x3+x1:x2:x3))
  expect_equal(as.numeric(summary_fit_linReg$residuals), as.numeric(summary_fit_lm$residuals))
  expect_equal(summary_fit_linReg$model.p.value, 1-pf(as.numeric(summary_fit_lm$fstatistic[1]), as.numeric(summary_fit_lm$fstatistic[2]), as.numeric(summary_fit_lm$fstatistic[3])))
})

test_that("3-way interaction included with some interaction terms not appearing as individual terms",{
  y<<-rnorm(100)
  x1<<-rnorm(100)
  x2<<-rnorm(100)
  x3<<-rnorm(100)

  fit_linReg<-linearRegression(y~x1+x2+x1:x2+x2:x3+x1:x2:x3)
  fit_lm<-lm(y~x1+x2+x1:x2+x2:x3+x1:x2:x3)
  ...
  expect_equal(fit_linReg$df.residual,fit_lm$df.residual)
  expect_equal(as.numeric(as.matrix(fit_linReg$model)), as.numeric(as.matrix(fit_lm$model)))
  expect_equal(fit_linReg$formula, formula(y~x1+x2+x1:x2+x2:x3+x1:x2:x3))
  ...
  expect_equal(summary_fit_linReg$F.stat, as.numeric(summary_fit_lm$fstatistic[1]))
  expect_equal(summary_fit_linReg$df, as.vector(summary_fit_lm$fstatistic[2:3]))
  expect_equal(summary_fit_linReg$formula, formula(y~x1+x2+x1:x2+x2:x3+x1:x2:x3))
  expect_equal(as.numeric(summary_fit_linReg$residuals), as.numeric(summary_fit_lm$residuals))
  expect_equal(summary_fit_linReg$model.p.value, 1-pf(as.numeric(summary_fit_lm$fstatistic[1]), as.numeric(summary_fit_lm$fstatistic[2]), as.numeric(summary_fit_lm$fstatistic[3])))
})
